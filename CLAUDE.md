...
**Render pipeline:** Universal Render Pipeline (URP). An editor bootstrap script auto-creates the URP pipeline asset on first import so a fresh clone doesn't need the URP-converter wizard.
